      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-col items-center md:items-start gap-2">
            <span className="font-[family-name:var(--font-display)] font-extrabold text-xl gradient-text tracking-tight">Cyrino Connect</span>
            <p className="text-cyrano-muted text-sm">A World Less Lonely</p>
            <p className="text-cyrano-muted text-xs">&copy; {new Date().getFullYear()} Cyrino LC. All rights reserved.</p>
          </div>
